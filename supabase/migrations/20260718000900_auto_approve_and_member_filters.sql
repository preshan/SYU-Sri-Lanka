-- Auto-approve registrations; keep location indexes for admin member filters

-- Flip existing pending applications to active
...
create index if not exists profiles_district_ds_created_idx
  on public.profiles (district_id, ds_division_id, created_at desc);
